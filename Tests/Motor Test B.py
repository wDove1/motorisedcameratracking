...
class MotorControl:
    ...
    def measureMotorSpecsOne(self,distance):
        ...
        t1=threading.Thread(target=self.updaterTest,)
...
M=MotorControl( {'name': "28BJY48_ULN2003_RPI", 'maxSpeed': 50, 'minWaitTime': 0.0012},  {'name': "28BJY48_ULN2003_RPI", 'maxSpeed': 50, 'minWaitTime': 0.0012})
a,b=M.measureMotorSpecsOne(360)
print(a)
#print(b)
